...
public class SimpleDataGenScriptCreator
{
	...
	/**
	 * This is an entry point of program when it is started.
	 * <p>
	 * It retrivies arguments from command line that must correspond to this template:
	 * (SQL statement, row count, column value template), where 'column value template'
         * is a sequence of arguments that represent fixed and generated fragments of value.
         * Argument for fixed fragment is a text literal and argument for generated fragment 
         * is a length of generated by program char sequence. SQL statement must contain a 'value' 
         * placeholder for generated column values.
         * <p>
         * For example, cmd: "INSERT INTO HELLOSERVICE.Contacts(name) VALUES(value);" 10 fixedtext 5
         * will generate 10 INSERT commands where 'value' will be replaced with values such as 
         * fixedtext[generated]'.
	 * 
	 * @param:     args        an array of strings that contains information about 
